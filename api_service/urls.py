# -*- coding: utf-8 -*-
"""
ForgeForth Africa - API Service URLs
====================================
URL routing for API Service operations.
"""
...
urlpatterns = [
   # Health
    ...
    # Authentication
    path('auth/login/', views.api_service_login, name='login'),
    path('auth/logout/', views.api_service_logout, name='logout'),
